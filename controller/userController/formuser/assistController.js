...
const assistform = require('../../../models/modeluser/assistuser')
...
module.exports = (req,res) => {
    ...
    let data = new assistform ({
        ...
        discriotion1: req.body.discriotion1,
    ...
    assistform.saveForm(data,(err) => {
        if(err) console.log(err)   
        res.redirect('/formassist') 
    })
}